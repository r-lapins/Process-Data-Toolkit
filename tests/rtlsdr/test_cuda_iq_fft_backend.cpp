...
TEST(CudaIqFftBackendTest, ComputesPositiveIqFrequency)
{
    ...
    EXPECT_EQ(result.algorithm, pdt::SpectrumAlgorithm::cuFft);
}

TEST(CudaIqFftBackendTest, ComputesNegativeIqFrequency)
{
    constexpr double sample_rate = 1024.0;
    constexpr std::size_t size = 1024;
